...
function! s:FixCurlies(line1,line2)
  let l:save_cursor = getpos(".")
  silent! execute ':' . a:line1 . ',' . a:line2 . 's/\([^ #}]\{1\}\)}/\1 }/g'
  silent! execute ':' . a:line1 . ',' . a:line2 . 's/{\([^ {]\{1\}\)/{ \1/g'
  silent! execute ':' . a:line1 . ',' . a:line2 . 's/#{ \([^}]\+\) }/#{\1}/g'
  silent! execute ':' . a:line1 . ',' . a:line2 . 's/{{ \([^}]\+\) }}/{{\1}}/g'
  call setpos('.', l:save_cursor)
endfunction

command! -range=% FixCurlies call <SID>FixCurlies(<line1>,<line2>)
